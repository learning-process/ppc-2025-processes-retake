...
ОС - Windows 10 - **Инструментарий : **MinGW - w64(g++ 7.3.0, x86_64 - posix - seh),
    ...
    где выигрыш от распараллеливания превышает накладные расходы на коммуникацию 3. Чётно -
        ...
        4. На малых объемах данных последовательная версия предпочтительнее 
        из-за отсутствия накладных расходов на межпроцессное взаимодействие

        ##9. Ссылки 1. Лекции по параллельному программированию
        2. Практические занятия по параллельному программированию 
        3. Batcher, K.E.(1968)."Sorting networks and their applications".Proceedings of the April 30 - May 2,
