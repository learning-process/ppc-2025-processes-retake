...
Параллельные вычисления являются важным направлением современного программирования, позволяющим значительно ускорить обработку больших объёмов данных. В данной работе рассматривается задача поиска минимального элемента в векторе с использованием технологии MPI (Message Passing Interface) для распределения вычислений между несколькими процессами.

Цель работы — реализовать корректный и масштабируемый параллельный алгоритм поиска минимума и провести анализ его производительности.
