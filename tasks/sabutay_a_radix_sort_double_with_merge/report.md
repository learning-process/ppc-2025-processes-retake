    ...
    Technology:SEQ, MPI - Variant:20
                                  ...
                                  ##1. Introduction
                                      ...
                                      В данной работе рассматривается задача сортировки массива вещественных чисел
                                          типа `double` с использованием поразрядной
...
Параллельная реализация использует модель MPI со следующим подходом :
    ...
    : -процессы с меньшими рангами принимают данные от соседних процессов -
      ...
      -
      Структура проекта : - `common / include /
                          common.hpp` — общие типы данных и базовый класс
                              задачи - `seq /` — последовательная реализация - `mpi /` — параллельная реализация -
    ...
    : mpiexec
      -
      n 2 .\ppc_func_tests.exe-- gtest_filter = SabutayARadixSortDoubleMergeFuncTests/*
