...
Лексикографическое сравнение строк является базовой операцией, используемой в алгоритмах сортировки, поиска и обработки текста.

Цель работы — реализовать проверку лексикографической упорядоченности двух строк в последовательной (SEQ) и параллельной (MPI) версиях, а также оценить ускорение и эффективность параллельной реализации.
