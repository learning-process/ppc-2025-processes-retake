...
используя вычисленные глобальные значения.С помощью MPI_Allgatherv все процессы обмениваются обработанными сегментами, и каждый процесс получает полное итоговое изображение.
