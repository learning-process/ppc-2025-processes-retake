...
## 8. Conclusions
MPI реализация алгоритма увеличения контраста демонстрирует положительное ускорение на всех тестируемых конфигурациях. Максимальное ускорение 1.94 достигнуто в режиме pipeline при использовании 4 процессов. На 8 процессах ускорение несколько снижается (до 1.58), что связано с возросшими накладными расходами на коммуникацию.
