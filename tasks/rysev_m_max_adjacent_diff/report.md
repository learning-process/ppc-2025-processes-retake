...
SEQ версия алгоритма выполняется за 0,0005690098 с., а MPI версия за 0,0003310212 с.
Доля ускорения составляет 1,71
...
Основные достижения:
    ...
    Высокая эффективность (86%) на 2 процессах подтверждает правильность выбранного подхода

Наблюдения:

    Задача хорошо поддается распараллеливанию благодаря независимости вычислений внутри сегментов
