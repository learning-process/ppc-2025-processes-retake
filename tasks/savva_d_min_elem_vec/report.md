...
## Заключение.
В ходе лабораторной работы был реализован и протестирован алгоритм нахождения минимума вектора с использованием технологии MPI. 
Проведён сравнительный анализ с последовательной версией, подтверждена корректность вычислений и измерено ускорение. 
Было так же показано, что MPI версия при достаточно больших данных имеет ускорение по сравнению с версией SEQ.
