...
class MarovRadixSortDoubleFuncTests : public ppc::util::BaseRunFuncTests<InType, OutType, TestType> {
 public:
...
const std::array kTestCases = {
    std::make_tuple(std::vector<double>{5.0, 2.0, 8.0, 1.0, 9.0}, std::vector<double>{1.0, 2.0, 5.0, 8.0, 9.0}),
...
const auto kAllTestTasks = std::tuple_cat(
    ppc::util::AddFuncTask<MarovRadixSortDoubleMPI, InType>(kTestCases, PPC_SETTINGS_marov_radix_sort_double),
    ppc::util::AddFuncTask<MarovRadixSortDoubleSEQ, InType>(kTestCases, PPC_SETTINGS_marov_radix_sort_double));

INSTANTIATE_TEST_SUITE_P(RadixSortDoubleFuncTests, MarovRadixSortDoubleFuncTests,
