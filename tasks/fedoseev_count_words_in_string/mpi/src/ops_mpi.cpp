...
bool FedoseevCountWordsInStringMPI::ValidationImpl() {
  return GetOutput() == 0;
}

bool FedoseevCountWordsInStringMPI::PreProcessingImpl() {
  GetOutput() = 0;
  return true;
}

bool FedoseevCountWordsInStringMPI::RunImpl() {
  int rank = 0;
  int size = 1;
...
bool FedoseevCountWordsInStringMPI::PostProcessingImpl() {
  return true;
}
